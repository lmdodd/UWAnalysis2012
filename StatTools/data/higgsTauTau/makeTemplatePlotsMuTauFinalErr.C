{
   ...
   makeLTauStackPF("~/www/htt/muTau/m_sv_muTau_2012log","muTauPlots/MSSM/muTau_svMassNoLog.root","muTau_inclusive",0,"m_{#tau#tau}","GeV",false,"#tau_{#mu}#tau_{h}","2012",true,true,ztt,tt,w,zl,zj,vv,qcd,err,false);
